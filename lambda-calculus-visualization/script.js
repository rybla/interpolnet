...
function parseLambda(str) {
  ...
  if (tokens.length > 0) {
    throw new Error("Extra tokens at the end of expression");
  }
  return term;
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function draw(interpolation = 1) {
        ...
        if (currentTerm) {
            ...
            drawTerm(currentTerm, canvas.width / 2 - layoutToDraw.width / 2, 50, layoutToDraw);
        }
    }
    ...
    lambdaInput.addEventListener('input', resetSimulation);
